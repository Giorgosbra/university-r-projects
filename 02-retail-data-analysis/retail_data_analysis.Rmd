---
title: "Εργασία 2"
author: " Γιώργος Μπρασινίκας - ba21669214,
Γρηγόρης Κατσαμπάνης - ba21669116 "
...
## Εισαγωγή
Το παρόν RMarkdown αρχείο περιγράφει αναλυτικά όλα τα στάδια καθαρισμού, μετασχηματισμού και ανάλυσης των δεδομένων πωλήσεων τεσσάρων καταστημάτων για χρονικό ορίζοντα ενός έτους.
 
  
## Ερώτημα 1: Καθαρισμός δεδομένων

Στο πρώτο ερώτημα πραγματοποιείται ο καθαρισμός και η προετοιμασία των δεδομένων πωλήσεων και κατηγοριών    προϊόντων. Η διαδικασία περιλαμβάνει ανάγνωση των αρχείων, μετατροπή τύπων μεταβλητών, έλεγχο για ελλείπουσες    τιμές, αφαίρεση διπλότυπων εγγραφών και φιλτράρισμα μη έγκυρων ή ακραίων παρατηρήσεων.
...
# Τα δεδομένα καθαρίστηκαν από διπλότυπα, μη έγκυρες τιμές και ακραίες παρατηρήσεις.
```
...
Χρησιμοποιώντας το αρχείο Categories.csv, δημιουργείται μια νέα σύνθετη μεταβλητή κατηγορίας (category path), η οποία συνδυάζει τα επίπεδα κατηγοριοποίησης ενός προϊόντος. Η μεταβλητή αυτή μπορεί να χρησιμοποιηθεί άμεσα για ομαδοποιήσεις και οπτικοποιήσεις.
...
Στο ερώτημα αυτό υπολογίζονται τα συνολικά ημερήσια έσοδα και εντοπίζονται οι ημέρες με τη μεγαλύτερη και τη μικρότερη αξία εισπράξεων.
...
Απεικονίζονται τα εβδομαδιαία έσοδα κάθε καταστήματος για τους τρεις τελευταίους μήνες του χρονικού ορίζοντα.
...
Υπολογίζονται τα δέκα προϊόντα με τη μεγαλύτερη ποσότητα πωλήσεων για κάθε μήνα και κατάστημα.
...
Εξετάζεται η εμπειρική κατανομή των υπόλοιπων κατηγοριών προϊόντων σε καλάθια που περιέχουν γαλακτοκομικά είδη.
...
Εντοπίζονται τα προϊόντα που εμφανίζονται και στα τέσσερα καταστήματα.
...
Εξετάζεται η σχέση μεταξύ ποικιλίας προϊόντων σε ένα καλάθι και της συνολικής αξίας του.
...
Εξετάζεται κατά πόσο η αναλογία τροφίμων σε ένα καλάθι επηρεάζει τη συνολική του αξία.
